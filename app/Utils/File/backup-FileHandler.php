...
class FileHandler
{
    ...
    //return existing custom types of files classes directory
        ...
        {
            $path =self::getUtilsDir().DIRECTORY_SEPARATOR."Types";
            $list = glob($path.DIRECTORY_SEPARATOR.'*.php');
            return $list;
        }
        ...
        public static function fixPath($path)
        {
            ...
            $splitedPathByApp = explode(DIRECTORY_SEPARATOR.'app',$path);
    ...
    public static function findClassType($extension,$file = null,$fileName = null)
    {
        ...
        try{
            ...
            $fixedClass = new $fixedPath['path']($file,$fileName,$extension);
        }
    ...
    public static function compressAndDownloadAllFilesByUser(User $user)
    {
        ...
        if ( $zip->open(public_path('storage\\temp\\'.$zipFilename), ZipArchive::CREATE) === TRUE){
            ...
            foreach ($files as $file) {
                ...
                $class = self::findClassType($extension,null,null);
